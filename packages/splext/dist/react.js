import { splitText, __spreadProps, __spreadValues } from './chunk-XSMWGDBM.js';
import { useRef, useState, useLayoutEffect, useCallback, useEffect, isValidElement, cloneElement } from 'react';
...
function SplitText({
  ...
  return /* @__PURE__ */ jsx("div", { ref: containerRef, style: { visibility: "hidden" }, children: clonedChild });
}
